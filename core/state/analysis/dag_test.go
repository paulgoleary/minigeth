...
func TestTransactionDAG(t *testing.T) {
	...
	// ignoreDepPrefixes := []string{"742d13f0b2a19c823bdd362b16305e4704b97a38", "70bca57f4579f58670ab2d18ef16e02c17553c38"} // 31218048
	ignoreDepPrefixes := []string{"f0245f6251bef9447a08766b9da2b07b28ad80b0", "70bca57f4579f58670ab2d18ef16e02c17553c38"} // 31218048

	f, err := os.Open("/Users/pauloleary/work/data_31212704.csv")
